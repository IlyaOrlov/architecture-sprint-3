...
Для реализации микросервисов выбран язык Java и фреймврок Spring, т.к. эти инструменты позволяют реализовать надёжное синхронное приложение, взаимодейтсвующее с реляционной БД. Также, с помощью этих инструментов реализован исходный монолит, что означает наличие соответствующего опыта у команды и упрощает разработку за счёт переиспользования отдельных элементов кодовой базы монолита.
